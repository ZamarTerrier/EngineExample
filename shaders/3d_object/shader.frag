...
layout(binding = 5) uniform sampler2D diffuse;
...
void main() {
    ...
    if(lsb.isEnable != 0)
    {
        ...
        for(int i =0;i < lsb.num_dirs;i++){
            ...
            fullColor += CalcDirLight(d_light, fragNormal, some_vec, color.rgb);
        ...
        for(int i =0;i < lsb.num_points;i++){
            ...
            fullColor += CalcPointLight(light, fragNormal, some_vec, L.xyz, color.rgb);
        }
        ...
        for(int i =0;i < lsb.num_spots;i++){
            ...
            fullColor += CalcSpotLight(light, fragNormal, some_vec, L.xyz, color.rgb);
        }
